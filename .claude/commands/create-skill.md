...
2. Infer the skill's purpose and the right `ModelConfig` preset from the description
3. Create `melinoe/workflows/skills/{name}.py` with a complete `Step` subclass
4. Update `melinoe/workflows/skills/__init__.py` to export the new class
